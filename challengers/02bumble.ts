namespace hourOfAi.tower {
    export function createBumble() {
        return new Challenger(
            ...
            "Bumble",
            [
                tower.dialog("Bzzzz.... Bzzzz.... Bzzzz....", introCutscene, imgs.bumble_asleep),
                tower.dialog("Oh!"),
    ...
    function initBG(context: tower.DialogContext) {

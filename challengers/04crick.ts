namespace hourOfAi.tower {
    export function createCrick() {
        return new Challenger(
            ...
            "Crick",
            [
                tower.dialog("Oh? Why hello there!", introCutscene),
            ...
            [
                tower.dialog("Jolly good! Better luck next time, eh?", playerLoseCutscene)
            ],
            [
                tower.dialog("Well, I say! Smashing!", playerWinCutscene),

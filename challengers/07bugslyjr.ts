namespace hourOfAi.tower {
    export function createBugslyJr() {
        return new Challenger(
            ...
            "Bugsly Jr.",
            [
                tower.dialog("Finally! Now I just need to dodge these spikes and...", introCutscene),
                tower.dialog("Huh?", playGameOverSoundEffect),
            ...
            [
                tower.dialog("You'll always remember the Bugsly name!", playerLoseCutscene)
            ],
            [
                tower.dialog("*sniffle* Waaah! Daddy...!", playerWinCutscene)
            ],
            imgs.bugslyJr,
    ...
    function playGameOverSoundEffect(context: DialogContext) {

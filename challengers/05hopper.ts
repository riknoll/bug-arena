namespace hourOfAi.tower {
    export function createHopper() {
        return new Challenger(
            ...
            "Hopper",
            [
                tower.dialog("You beat that old fool Crick, eh?", introCutscene),
            ...
            [
                tower.dialog("Hahaha! Too easy!", playerLoseCutscene)
            ],
            [
                tower.dialog("Now I'm hopping mad!", playerWinCutscene)
            ],
            imgs.hopper,
